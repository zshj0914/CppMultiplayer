...
//
bool UPuzzlePlatformsGameInstance::SocketCreate(FString IPStr, int32 port)
{
...
bool UPuzzlePlatformsGameInstance::SocketSend(FString message)
{
...
bool UPuzzlePlatformsGameInstance::SocketReceive()
{
	m_RecvThread = FRunnableThread::Create(new FReceiveThread(Host), TEXT("RecvThread"));
	return true;
}

bool UPuzzlePlatformsGameInstance::ThreadEnd()
{
...
FString UPuzzlePlatformsGameInstance::StringFromBinaryArray(TArray<uint8> BinaryArray)
{
